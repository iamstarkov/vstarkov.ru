...
3. Если делаете адаптивно, то `<meta viewport="width=device-width" />`, иначе `<meta viewport="1024px" />`, где `1024px` можно заменить на максимальную ширину контентной области или меньше.
