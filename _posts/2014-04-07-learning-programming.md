...
description: Если вы программируете уже много лет, то вам этот вопрос может показать одновременно и лёгким и сложным. Лично меня он поставил в тупик и я начал перебирать в голове блок-схемы, переменные, циклы и условия.
