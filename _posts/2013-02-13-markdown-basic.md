...
(используемый в джекиле) создал синтаксис для списка определений `dl`; а **ГФМ**
([GitHub Flavored Markdown)](https://help.github.com/articles/github-flavored-markdown)
взял на себя больше и ввёл много крутых особенностей для создания более удобного
сервиса.
...
Код из статьи (её маркдаун-исходник лежит на гитхабе) можно тестировать в онлайн
редакторах:
