...
**Дисклеймер:**  
Данный документ является переводом первой версии [рекоммендаций](https://github.com/csswizardry/CSS-Guidelines) от [Гарри Робертса](http://csswizardry.com/). После публикации в перевод были внесены изменения для синхронизации с оригинальным репозиторием, из-за чего [актуальную версию](https://github.com/matmuchrapna/CSS-Guidelines) перевода можно найти в моём аккаунте на гитхабе.
---------
