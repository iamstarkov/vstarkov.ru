...
--------------
Перевод [рекоммендаций](https://github.com/csswizardry/CSS-Guidelines) от [@csswizardry](http://csswizardry.com/)  
Присылать исправления можно в [форк проекта](https://github.com/matmuchrapna/CSS-Guidelines) на гитхабе.